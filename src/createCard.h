...
if (cardName == "Air Elemental") return std::make_unique<AirElemental>(player);
else if (cardName == "Earth Elemental") return std::make_unique<EarthElemental>(player);
// else if (cardName == "Fire Elemental") return std::make_unique<FireElemental>(player);
else if (cardName == "Potion Seller") return std::make_unique<PotionSeller>(player);
...
else if (cardName == "Blizzard") return std::make_unique<Blizzard>(player);
...
else if (cardName == "Dark Ritual") return std::make_unique<DarkRitual>(player);
